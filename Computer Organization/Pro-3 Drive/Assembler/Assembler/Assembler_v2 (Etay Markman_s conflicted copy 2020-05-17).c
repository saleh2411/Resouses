...
Memory* SecoundRun(FILE* file) {
    ...
    while ((fgets(line, MAX_LINE, file)) != NULL) // To prevent last line reading twice
    {
        ...
        if (strstr(line, wo) != NULL) ///////// in case of the special .word order
        {
            ...
            head = add_line(head, option, rd, rs, rt, imm, pos);

            // update the location of the end of the memory
            if (pos > pos1) 
                pos1 = pos;
        }
		else if (strstr(line, dots) != NULL)//in case of regular .ward order and label
		{
			if (strstr(line, "#") != NULL)//now we check if the dots is remark and not a label
			{
				...
				{
					// check if the line includs only lable or #
					k = 0;
					while (line[k] != ':')
						k++;
					k++;
                    ...
                    head = add_line(head, option, rd, rs, rt, imm, pos);
					i++;
					if (i > pos1) //Update last line position
						pos1 = i;

				}
				else // The line has no lable
				{
					j = 0; // Read the order
					while (line[k] != ' ')
					{
			...
			else //There is no remark line
			{
				...
				imm[j] = '\0';
				// Copy Line to MemoryLine structure
                head = add_line(head, option, rd, rs, rt, imm, pos);
				i++;
				if (i > pos1) //Update last line position
					pos1 = i;
		...
		{
			k = 0;
			while ((line[k] == ' ') || (line[k] == '\t')) // roll to end of spaces
				k++;
			if (line[k] == '#')
				continue;
			if (line[k] == '\n')
    ...
    // create memory structure and return it
...
void PrintDataToFile(Memory* mem, FILE *ftw)
{
	...
	while (mem->head != NULL && i <= mem->last)
	{
		...
		MemoryLine *currentLine = getAtPos(mem->head, i);
		// Printing Opcode. if data for the ith row does not exist print a zero
		{if (currentLine == NULL)
			fprintf(ftw, "0");
		if (strcmp(currentLine->opcode, "add") == 0) 
			fprintf(ftw, "0");
		else if(strcmp(currentLine->opcode, "sub") == 0)
			fprintf(ftw, "1");
		else if(strcmp(currentLine->opcode, "and") == 0)
			fprintf(ftw, "2");
		else if(strcmp(currentLine->opcode, "or") == 0)
			fprintf(ftw, "3");
		else if(strcmp(currentLine->opcode, "sll") == 0)
			fprintf(ftw, "4");
		else if(strcmp(currentLine->opcode, "sra") == 0)
			fprintf(ftw, "5");
		else if(strcmp(currentLine->opcode, "limm") == 0)
			fprintf(ftw, "6");
		else if(strcmp(currentLine->opcode, "beq") == 0)
			fprintf(ftw, "7");
		else if(strcmp(currentLine->opcode, "bgt") == 0)
			fprintf(ftw, "8");
		else if(strcmp(currentLine->opcode, "ble") == 0)
			fprintf(ftw, "9");
		else if(strcmp(currentLine->opcode, "bne") == 0)
			fprintf(ftw, "A");
		else if(strcmp(currentLine->opcode, "jal") == 0)
			fprintf(ftw, "B");
		else if(strcmp(currentLine->opcode, "lw") == 0)
			fprintf(ftw, "C");
		else if(strcmp(currentLine->opcode, "sw") == 0)
			fprintf(ftw, "D");
		else if(strcmp(currentLine->opcode, "jr") == 0)
			fprintf(ftw, "E");
		else if(strcmp(currentLine->opcode, "halt") == 0)
			fprintf(ftw, "F");
		// if there is no opcode. this block of code is used to get the word for the .word command
		else if(strcmp(currentLine->opcode, "NONO") == 0) {
			if (strcmp(currentLine->rd, "NONO") == 0) {
				if (strcmp(currentLine->.rs, "NONO") == 0) {
					if (strcmp(currentLine->rt, "NONO") == 0) {
						if ((currentLine->imm[0] == '0') && (currentLine->imm[1] == 'x')) //Check if immidiate in hex
						{
		...
		else // if there is nothing print a zero
			fprintf(ftw, "0"); }

		// Printing Rd
		{if (currentLine == NULL)
			fprintf(ftw, "0"); 
		if (strcmp(currentLine->rd, "$zero") == 0)
			fprintf(ftw, "0");
		else if(strcmp(currentLine->rd, "$at") == 0)
			fprintf(ftw, "1");
		else if(strcmp(currentLine->rd, "$v0") == 0)
			fprintf(ftw, "2");
		else if(strcmp(currentLine->rd, "$a0") == 0)
			fprintf(ftw, "3");
		else if(strcmp(currentLine->rd, "$a1") == 0)
			fprintf(ftw, "4");
		else if(strcmp(currentLine->rd, "$t0") == 0)
			fprintf(ftw, "5");
		else if(strcmp(currentLine->rd, "$t1") == 0)
			fprintf(ftw, "6");
		else if(strcmp(currentLine->rd, "$t2") == 0)
			fprintf(ftw, "7");
		else if(strcmp(currentLine->rd, "$t3") == 0)
			fprintf(ftw, "8");
		else if(strcmp(currentLine->rd, "$s0") == 0)
			fprintf(ftw, "9");
		else if(strcmp(currentLine->rd, "$s1") == 0)
			fprintf(ftw, "A");
		else if(strcmp(currentLine->rd, "$s2") == 0)
			fprintf(ftw, "B");
		else if(strcmp(currentLine->rd, "$gp") == 0)
			fprintf(ftw, "C");
		else if(strcmp(currentLine->rd, "$sp") == 0)
			fprintf(ftw, "D");
		else if(strcmp(currentLine->rd, "$fp") == 0)
			fprintf(ftw, "E");
		else if(strcmp(currentLine->rd, "$ra") == 0)
			fprintf(ftw, "F");
		else if(strcmp(currentLine->rd, "NONO") == 0)
			num = 0;
		else
			fprintf(ftw, "0"); }
		...
		{if (currentLine == NULL)
			fprintf(ftw, "0"); 
		if (strcmp(currentLine->rs, "$zero") == 0)
			fprintf(ftw, "0");
		else if(strcmp(currentLine->rs, "$at") == 0)
			fprintf(ftw, "1");
		else if(strcmp(currentLine->rs, "$v0") == 0)
			fprintf(ftw, "2");
		else if(strcmp(currentLine->rs, "$a0") == 0)
			fprintf(ftw, "3");
		else if(strcmp(currentLine->rs, "$a1") == 0)
			fprintf(ftw, "4");
		else if(strcmp(currentLine->rs, "$t0") == 0)
			fprintf(ftw, "5");
		else if(strcmp(currentLine->rs, "$t1") == 0)
			fprintf(ftw, "6");
		else if(strcmp(currentLine->rs, "$t2") == 0)
			fprintf(ftw, "7");
		else if(strcmp(currentLine->rs, "$t3") == 0)
			fprintf(ftw, "8");
		else if(strcmp(currentLine->rs, "$s0") == 0)
			fprintf(ftw, "9");
		else if(strcmp(currentLine->rs, "$s1") == 0)
			fprintf(ftw, "A");
		else if(strcmp(currentLine->rs, "$s2") == 0)
			fprintf(ftw, "B");
		else if(strcmp(currentLine->rs, "$gp") == 0)
			fprintf(ftw, "C");
		else if(strcmp(currentLine->rs, "$sp") == 0)
			fprintf(ftw, "D");
		else if(strcmp(currentLine->rs, "$fp") == 0)
			fprintf(ftw, "E");
		else if(strcmp(currentLine->rs, "$ra") == 0)
			fprintf(ftw, "F");
		else if(strcmp(currentLine->rs, "NONO") == 0)
			num = 0;
		else
			fprintf(ftw, "0"); }
		...
		{if (currentLine == NULL)
			fprintf(ftw, "0"); 
		if (strcmp(currentLine->rt, "$zero") == 0)
			fprintf(ftw, "0");
		else if(strcmp(currentLine->rt, "$at") == 0)
			fprintf(ftw, "1");
		else if(strcmp(currentLine->rt, "$v0") == 0)
			fprintf(ftw, "2");
		else if(strcmp(currentLine->rt, "$a0") == 0)
			fprintf(ftw, "3");
		else if(strcmp(currentLine->rt, "$a1") == 0)
			fprintf(ftw, "4");
		else if(strcmp(currentLine->rt, "$t0") == 0)
			fprintf(ftw, "5");
		else if(strcmp(currentLine->rt, "$t1") == 0)
			fprintf(ftw, "6");
		else if(strcmp(currentLine->rt, "$t2") == 0)
			fprintf(ftw, "7");
		else if(strcmp(currentLine->rt, "$t3") == 0)
			fprintf(ftw, "8");
		else if(strcmp(currentLine->rt, "$s0") == 0)
			fprintf(ftw, "9");
		else if(strcmp(currentLine->rt, "$s1") == 0)
			fprintf(ftw, "A");
		else if(strcmp(currentLine->rt, "$s2") == 0)
			fprintf(ftw, "B");
		else if(strcmp(currentLine->rt, "$gp") == 0)
			fprintf(ftw, "C");
		else if(strcmp(currentLine->rt, "$sp") == 0)
			fprintf(ftw, "D");
		else if(strcmp(currentLine->rt, "$fp") == 0)
			fprintf(ftw, "E");
		else if(strcmp(currentLine->rt, "$ra") == 0)
			fprintf(ftw, "F");
		else if(strcmp(currentLine->rt, "NONO") == 0)
			num = 0;
		else
			fprintf(ftw, "0"); }

		if (currentLine != NULL) {
			if (strcmp(currentLine->opcode, "NONO") != 0) //If order is .word, print num
			{
				if ((currentLine->imm[0] == '0') && (currentLine->imm[1] == 'x')) //Check if immidiate in hex
				{
					num = strtol(currentLine->imm, NULL, 16);
